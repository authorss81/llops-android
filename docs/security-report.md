...
| B1-DB-4 | HIGH | phase-44 | `FIXED` (commit pending; see `workspace/phase-44/REPORT.md`) |
| B1-AUTH-06 | MEDIUM | phase-44 (grouped with B1-DB-4, same root cause) | `FIXED` (commit pending; see `workspace/phase-44/REPORT.md`) |
