...
| R2-B1P-02 | LOW | android platform surface | → phase-141 (2026-08-17 triage) |
| R2-B1P-03 | LOW | android platform surface | → phase-141 (2026-08-17 triage) |
...
- **Status:** open → **triaged to fix-phase 141** (2026-08-17, generated by phase-119)
- **Severity:** LOW
...
| R2-b2b3-LOG-04 | LOW | logging/info-disclosure — Export Engine leaks note title in subject | → phase-141 (2026-08-17 triage) |
