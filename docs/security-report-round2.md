...
| R2-B1A-03 | LOW | app logic & auth | → phase-140 (2026-08-17 triage) |
...
| R2-B1P-05 | INFO | android platform surface | → phase-140 (2026-08-17 triage) |
...
- **Status:** open → **triaged to fix-phase 140** (2026-08-17, generated by phase-119)
- **Severity:** LOW
...
| R2-b2b1-UI-02 | LOW | Compose/UI — dialog window FLAG_SECURE | → phase-140 (2026-08-17 triage) |
