...
| R2-B1C-02 | LOW | crypto (credential key mgmt) | → phase-145 (2026-08-17 triage) |
| R2-B1C-03 | INFO | crypto (in-memory hygiene) | → phase-145 (2026-08-17 triage) |
...
- **Status:** open → **triaged to fix-phase 145** (2026-08-17, generated by phase-119)
- **Severity:** LOW
