...
/**
 * Pure, JVM-testable input validation for an OCR request (moved from the base
 * app in phase-175).
 */
...
object OcrErrorMapper {
    ...
    /** The user-facing "no readable text" notice (kept from the base app). */
    fun noTextMessage(): String = "No readable text found in the image."
