...
// Phase 175: the OCR/translation serving surfaces (TranslationLanguage,
// TranslationOutcome, TranslationModelStatus, TranslationPlugin, OcrPlugin,
// OcrOutcome) moved to plugin-sdk — com.authorss81.noteflow.plugins.
// OcrAndTranslationPlugin.kt — so the downloadable `plugins/mlkit` artifact
// compiles against the exact interfaces the base app resolves classloader-first.
